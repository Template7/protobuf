...
var file_proto_template7_user_v1_proto_rawDesc = []byte{
	...
	0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_proto_template7_user_v1_proto_goTypes = []interface{}{
	...
	(auth.Role)(0),                // 2: auth.Role
	(auth.AccountStatus)(0),       // 3: auth.AccountStatus
}
var file_proto_template7_user_v1_proto_depIdxs = []int32{
	2, // 0: user.UserInfoResponse.role:type_name -> auth.Role
	3, // 1: user.UserInfoResponse.status:type_name -> auth.AccountStatus
