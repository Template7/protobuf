...
import (
	v1 "github.com/Template7/protobuf/proto/template7/auth/v1"
...
type UserInfoResponse struct {
	...
	Status   v1.AccountStatus `protobuf:"varint,3,opt,name=status,proto3,enum=auth.AccountStatus" json:"status,omitempty"`
...
func (x *UserInfoResponse) GetStatus() v1.AccountStatus {
	if x != nil {
		return x.Status
	}
...
var file_proto_template7_user_v1_proto_rawDesc = []byte{
	...
	0x08, 0x6e, 0x69, 0x63, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65,
	0x37, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x37, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f,
...
var file_proto_template7_user_v1_proto_goTypes = []interface{}{
	...
	(v1.AccountStatus)(0),         // 2: auth.AccountStatus
}
